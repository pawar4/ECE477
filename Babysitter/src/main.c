...
//	value2 = I2C_read_nack(I2C2);
	...
	blockDataControl();
	blockDataClass(0x52);
	blockDataOffset(0x00);
	value4 = blockDataChecksum();
	value3 = readBlockData(10);
//	value3 = (value3 << 8) && readBlockData(11);
//	writeBlockData(10, 0x27);
//	writeBlockData(11, 0x10);
//	newc = computeBlockChecksum();
//	writeBlockChecksum(newc);
//	exitConfig(true);
//	value2 = capacity(DESIGN);
	//value2 = readControlWord(BQ27441_CONTROL_FW_VERSION);//firmware
	//value3 = soc(FILTERED); //state of charge (percentage)
	while(1);
